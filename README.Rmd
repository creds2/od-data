...
The challenges that the UK's passenger transport sector faces from an emissions perspective, including high level of car dependency and under-investment in and capacity limits on public transport [@anable_complacent_2005; @pisu_improving_2015b], are not unique to Norther Europe.
